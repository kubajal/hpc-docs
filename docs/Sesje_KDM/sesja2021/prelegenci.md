...
Opracowany model wykorzystany został do analizy stopu W38Ta36Cr15V11, wytworzonego później za pomocą rozpylania magnetronowego i charakteryzującego się bardzo wysoką odpornością na promieniowanie [2]. Uzyskane wyniki prawidłowo przewidziały powstawanie wydzieleń Cr-V blokujących powstawanie defektów punktowych i pętli dyslokacyjnych, a także wskazały potencjalne źródła tych wyjątkowych właściwości stopu W38Ta36Cr15V11.
...
Zostaną przedstawione wyniki badań obliczeniowych w ramach teorii funkcjonału gęstości:
